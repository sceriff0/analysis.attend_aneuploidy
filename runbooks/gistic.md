...
**Consumed by:** `analysis/08-tcga-classification.Rmd`.
...
The copy-number clustering in `08-tcga-classification.Rmd` **requires GISTIC output in
...
**Step 3 — knit `analysis/08-tcga-classification.Rmd`.** `load_gistic_thresholded()`
