...
#
# Sourced by BOTH:
#   analysis/01_data_integration.Rmd   (linkage diagnostics)
#   analysis/01_data_integration.Rmd  (dataset assembly + content QC)
#
...
# IDENTICAL to report 1's near-miss norm() so the recovery and the ledger that
...
# non-missing value. This is LOSSY by design — 01_data_integration.Rmd reports
