...
if (!is.null(cl)) {
  ...
  # cat(), not message(): opts_chunk sets message = FALSE, so this flag — which
  # 00-methods tells the reader to check BEFORE interpreting any cluster label — was
  # being discarded and never appeared on the knitted page at all.
