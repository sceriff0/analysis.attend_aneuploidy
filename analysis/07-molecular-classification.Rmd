...
high-burden cluster and the high-aneuploidy samples is corroboration, not circularity. The
binary high/low bar beside it splits at the **primary** cut
`r attend_thresholds$aneuploidy`; nothing in this report is keyed on the aneuploidy class —
the clusters are learned from copy number — so it is an annotation here rather than a
grouping, and the same tumours split at both configured cuts are in
[12-aneuploidy-immune](12-aneuploidy-immune.html).
