...
> **Out of scope.** The TCGA cascade -> [08_tcga_classification](08_tcga_classification.html). Aneuploidy within MMRd -> [05_aneuploidy_mmrd](05_aneuploidy_mmrd.html).
...
[00_methods](00_methods.html). Parts 1 and 2 are descriptive frequencies with **no
...
same barcode crosswalk [01_data_integration](01_data_integration.html) used, then the
...
[06_mutation_and_cna](06_mutation_and_cna.html), so neither figure can rank a
...
[06_mutation_and_cna](06_mutation_and_cna.html)'s frequency comparison uses.
